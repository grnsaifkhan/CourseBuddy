        ...
        if ($result) {
            ...
            foreach ($result as $sdata) {
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" style="text-decoration: none; color: #16BBD2" href="#?id=<?php echo $sdata['facid'];?>">Edit</a>&nbsp&nbsp|&nbsp&nbsp
                        <a class="btn btn-primary" style="text-decoration: none; color: #16BBD2" href="#?id=<?php echo $sdata['facid'];?>">Delete</a>
                    </td>
                </tr>
