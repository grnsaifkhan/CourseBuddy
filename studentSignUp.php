...
if (isset($_POST["submit"])) {
    ...
    $sqlsearch = "SELECT email FROM stdreg  WHERE email = '".$email."'";
    ...
    if (mysqli_num_rows($result)){
        ...
        $sql = "INSERT INTO stdreg(fname,lname,username,institute,department,email,password,gender,dob) VALUES('$fname','$lname','$username','$institute','$department','$email','$password','$gender','$dob')";
        if ($username != '' && $email != '') {
...
<div class="fix signup_main">
    <div  class="fix signupform">
        <form action="studentSignUp.php" method="POST">
            ...
            <a href="studentLogin.php" style="text-decoration: none; color: #ffffff; font-size: 15px">Have account? Please Log In</a>
        </form>
    </div>
</div>
